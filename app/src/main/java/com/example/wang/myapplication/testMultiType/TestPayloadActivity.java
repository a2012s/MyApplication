...
public class TestPayloadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String urlHead="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=302701032,2300144492&fm=27&gp=0.jpg";
        items = new Items();
        for (int i = 0; i < 10; i++) {
...
// 开始刷新，设置当前为刷新状态
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        items.clear();
                        for (int i = 0; i < 10; i++) {
                            items.add(new HeavyItem(i + "我是天才" + random.nextInt(100) + "号"));
                        }
                        adapter.notifyDataSetChanged();

                        Toast.makeText(TestPayloadActivity.this, "刷新了数据", Toast.LENGTH_SHORT).show();
