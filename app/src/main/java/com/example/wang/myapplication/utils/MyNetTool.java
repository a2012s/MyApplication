...
/**
 * Created by wjj on 2018/8/15 14:48
 * E-Mail ：wjj99@qq.com
 * 描述：判断网络状况
 */
public class MyNetTool {
     ...
     */
    public static int getNetWorkType(Context context, boolean isShowToast) {
        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    if (isShowToast) {
                        shortToast(context, "当前网络为wifi环境");
                    }
                    break;
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            netType = NETWORK_2G;
                            //ToastUtil.shortToast("切换到2G环境下");
                            if (isShowToast) {
                                shortToast(context, "当前网络为2G环境");
                            }
                            break;
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            // ToastUtil.shortToast("切换到3G环境下");
                            if (isShowToast) {
                                shortToast(context, "当前网络为3G环境");
                            }
                            break;
                        ...
                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
                            //ToastUtil.shortToast("切换到4G环境下");
                            if (isShowToast) {
                                shortToast(context, "当前网络为4G环境");
                            }
                            break;
                        default:
                            ...
                            //ToastUtil.shortToast("未知网络");
                            if (isShowToast) {
                                shortToast(context, "当前网络为未知网络");
                            }
                    }
                    break;
                default:
     ...
     * </ul>
     */
    public static String getNetWorkTypeName(Context context, boolean isShowToast) {
        switch (getNetWorkType(context, isShowToast)) {
            case NETWORK_WIFI:
                return "NETWORK_WIFI";
            case NETWORK_4G:
                return "NETWORK_4G";
